...
2.	Align reads using minimap2 (HiFi preset) and process BAM with samtools (~99.5% mapped)
3.	Run variant callers on GRCh38:
•	Clair3 (HiFi)
•	DeepVariant (PACBIO)
4.	Compare results to GIAB truth using hap.py to obtain precision and recall metrics
Prerequisites
Compute environment
